...
def define_trajectory():
    ...
    print("Enter desired relative motor displacement in mm. Positive value = towards motors.")
    ...
    motor_cmd = [float(motor1)/pitch*360 + motor_pos[0], float(motor2)/pitch*360 + motor_pos[1],\
    float(motor3)/pitch*360 + motor_pos[2], float(motor4)/pitch*360 + motor_pos[3]]
    count = 0
