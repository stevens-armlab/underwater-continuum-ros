...
void setup() {
  ...
  // test timier start
  motor_start_t = micros();
}

void loop() {
  // put your main code here, to run repeatedly:
  motor_test_t  = (float) (micros() - motor_start_t);
  motor_test_t = motor_test_t/1000000.0;
  // Set Goal Position in RAW value
  float motor_cmd_pos = 180 + 150 * sin(2*3.14*0.2*motor_test_t);
  dxl.setGoalPosition(DXL_ID, motor_cmd_pos, UNIT_DEGREE);
